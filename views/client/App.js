...
console.log(logo); // Our single Styled Component definition
...
var AppLogoSpinAnimation = (0, _styledComponents.keyframes)(["from{transform:rotate(0deg);}to{transform:rotate(360deg);}"]);

var AppLogo = _styledComponents.default.img.withConfig({
  displayName: "App__AppLogo",
  componentId: "sc-1xbx0kc-3"
})(["animation:", " infinite 20s linear;height:40vmin;"], AppLogoSpinAnimation);
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(AppContainer, null, _react.default.createElement(AppHeader, null, _react.default.createElement(AppLogo, {
        src: "../../assets/logo.svg",
        alt: "logo"
      }), _react.default.createElement("p", null, "Edit ", _react.default.createElement("code", null, "src/App.js"), " and save to reload."), _react.default.createElement(AppLink, {
